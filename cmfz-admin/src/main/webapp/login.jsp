	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#captchaImage").click(function() {//点击更换验证码
                var vcode = document.getElementById("captchaImage");
				...
				<table>
					<tbody>
					  ...
					  <tr>
							...
							<td>
								<input type="password" name="mgr_pwd" class="text"  maxlength="20" autocomplete="off"/>
							</td>
					  </tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src ="${pageContext.request.contextPath}/mgr/getVcode" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
